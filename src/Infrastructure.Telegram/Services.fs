...
type CallbackQueryService
  ...
  member this.ProcessAsync(callbackQuery: CallbackQuery) =
    ...
    let showExcludedPlaylists = Workflows.ExcludedPlaylist.list getPreset editMessageButtons
    let showTargetedPlaylists = Workflows.TargetedPlaylist.list getPreset editMessageButtons
    ...
    | Action.ExcludedPlaylist(ExcludedPlaylistActions.List(presetId, page)) -> showExcludedPlaylists presetId page
    ...
    | Action.ExcludedPlaylist(ExcludedPlaylistActions.Remove(presetId, playlistId)) ->
      ...
      let removeExcludedPlaylist = Workflows.ExcludedPlaylist.remove removeExcludedPlaylist answerCallbackQuery showExcludedPlaylists

      removeExcludedPlaylist presetId playlistId
    | Action.TargetedPlaylist(TargetedPlaylistActions.List(presetId, page)) -> showTargetedPlaylists presetId page
    ...
    | Action.TargetedPlaylist(TargetedPlaylistActions.Remove(presetId, playlistId)) ->
      ...
      let removeTargetedPlaylist = Workflows.TargetedPlaylist.remove removeTargetedPlaylist answerCallbackQuery showTargetedPlaylists
